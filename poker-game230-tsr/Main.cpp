...
struct Card {
	string suit;
	string face;
	//We use a val variable to evaluate the card, not the face
...
bool swap_cards(LinkedList<Card> &hand, LinkedList<Card> &deck) {
	...
	input.clear();
	cout << endl << "Now enter the face of the card you want (Two, Jack etc.):";
	cin >> input;
	while (input != "Two" && input != "Three" && input != "Four" && input != "Five" && input != "Six" && input != "Seven" && input != "Eight"
		...
		cout << endl << "Try again. Enter the face of the card you want (Two, Jack etc.):";
		input.clear();
		cin >> input;
	}
	string desired_face = input;
	input.clear();
	cout << endl << "Now enter the suit of the card you want (Hearts, Diamonds etc.):";
	cin >> input;
	while (input != "Hearts" && input != "Clubs" && input != "Diamonds" && input != "Spades") {
		cout << endl << "Try again. Enter the suit of the card you want (Hearts, Diamonds etc.   ):";
		input.clear();
		cin >> input;
	}
